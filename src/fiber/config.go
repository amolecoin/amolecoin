...
// NodeConfig configures the default CLI options for the amolecoin node.
// These parameters are loaded via cmd/amolecoin/amolecoin.go into src/amolecoin/amolecoin.go.
type NodeConfig struct {
	...
	// GenesisAddressStr is the amolecoin address that the genesis coins were sent to in the genesis block
	...
	// DisplayName is the display name of the coin in the wallet e.g. Amolecoin
	DisplayName string `mapstructure:"display_name"`
	// Ticker is the coin's price ticker, e.g. AMC
	...
	// CoinHoursTicker is the name of the coinhour asset type's price ticker, e.g. SCH (Amolecoin Coin Hours)
...
func setDefaults() {
	...
	viper.SetDefault("node.port", 9982)
	viper.SetDefault("node.web_interface_port", 9981)
	...
	viper.SetDefault("node.display_name", "Amolecoin")
	viper.SetDefault("node.ticker", "AMC")
	...
	viper.SetDefault("node.explorer_url", "https://explorer.amolecoin.com")
	viper.SetDefault("node.version_url", "https://version.amolecoin.com/amolecoin/version.txt")
	viper.SetDefault("node.bip44_coin", bip44.CoinTypeAmolecoin)
