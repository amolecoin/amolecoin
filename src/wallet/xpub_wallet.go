...
func (w *XPubWallet) GetAmolecoinAddresses() ([]cipher.Address, error) {
	if w.Meta.Coin() != CoinTypeAmolecoin {
		return nil, errors.New("XPubWallet coin type is not amolecoin")
	}
...
func (w *XPubWallet) GenerateAmolecoinAddresses(num uint64) ([]cipher.Address, error) {
	if w.Meta.Coin() != CoinTypeAmolecoin {
