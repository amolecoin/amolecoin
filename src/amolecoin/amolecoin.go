/*
Package amolecoin implements the main daemon cmd's configuration and setup
*/
package amolecoin
...
import (
	...
	"github.com/amolecoin/amolecoin/src/util/apputil"
	"github.com/amolecoin/amolecoin/src/util/certutil"
...
func (c *Coin) Run() error {
	...
	if err != nil {
		c.logger.Errorf("Database failed to open: %v. Is another amolecoin instance running?", err)
		return err
	}
...
func createCertFiles(certFile, keyFile string) error {
	org := "amolecoin daemon autogenerated cert"
