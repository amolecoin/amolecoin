...
func testAmoleencoderAnnounceBlocksMessage(t *testing.T, obj *AnnounceBlocksMessage) {
...
func TestAmoleencoderAnnounceBlocksMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderAnnounceBlocksMessage(t, tc.obj)
		})
	}
}
...
func testAmoleencoderAnnounceBlocksMessageDecodeErrors(t *testing.T, k int, tag string, obj *AnnounceBlocksMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderAnnounceBlocksMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderAnnounceBlocksMessageDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderAnnounceBlocksMessageDecodeErrors(t, i, "full", fullObj)
	}
}
