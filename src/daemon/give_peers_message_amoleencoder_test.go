...
func testAmoleencoderGivePeersMessage(t *testing.T, obj *GivePeersMessage) {
...
func TestAmoleencoderGivePeersMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderGivePeersMessage(t, tc.obj)
		})
	}
}
...
func testAmoleencoderGivePeersMessageDecodeErrors(t *testing.T, k int, tag string, obj *GivePeersMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderGivePeersMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderGivePeersMessageDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderGivePeersMessageDecodeErrors(t, i, "full", fullObj)
	}
}
