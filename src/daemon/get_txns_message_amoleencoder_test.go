...
func testAmoleencoderGetTxnsMessage(t *testing.T, obj *GetTxnsMessage) {
...
func TestAmoleencoderGetTxnsMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderGetTxnsMessage(t, tc.obj)
		})
	}
}
...
func testAmoleencoderGetTxnsMessageDecodeErrors(t *testing.T, k int, tag string, obj *GetTxnsMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderGetTxnsMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderGetTxnsMessageDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderGetTxnsMessageDecodeErrors(t, i, "full", fullObj)
	}
}
