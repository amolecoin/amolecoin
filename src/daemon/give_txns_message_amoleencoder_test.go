...
func testAmoleencoderGiveTxnsMessage(t *testing.T, obj *GiveTxnsMessage) {
...
func TestAmoleencoderGiveTxnsMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderGiveTxnsMessage(t, tc.obj)
		})
	}
}
...
func testAmoleencoderGiveTxnsMessageDecodeErrors(t *testing.T, k int, tag string, obj *GiveTxnsMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderGiveTxnsMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderGiveTxnsMessageDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderGiveTxnsMessageDecodeErrors(t, i, "full", fullObj)
	}
}
