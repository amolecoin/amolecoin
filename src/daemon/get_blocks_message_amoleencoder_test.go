...
func testAmoleencoderGetBlocksMessage(t *testing.T, obj *GetBlocksMessage) {
...
func TestAmoleencoderGetBlocksMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderGetBlocksMessage(t, tc.obj)
		})
	}
}
...
func testAmoleencoderGetBlocksMessageDecodeErrors(t *testing.T, k int, tag string, obj *GetBlocksMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderGetBlocksMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderGetBlocksMessageDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderGetBlocksMessageDecodeErrors(t, i, "full", fullObj)
	}
}
