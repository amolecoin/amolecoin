...
func testAmoleencoderGiveBlocksMessage(t *testing.T, obj *GiveBlocksMessage) {
...
func TestAmoleencoderGiveBlocksMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderGiveBlocksMessage(t, tc.obj)
		})
	}
}
...
func testAmoleencoderGiveBlocksMessageDecodeErrors(t *testing.T, k int, tag string, obj *GiveBlocksMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderGiveBlocksMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderGiveBlocksMessageDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderGiveBlocksMessageDecodeErrors(t, i, "full", fullObj)
	}
}
