...
import (
	...
	"github.com/amolecoin/amolecoin/src/daemon/gnet"
	"github.com/amolecoin/amolecoin/src/daemon/pex"
...
func TestIntroductionMessage(t *testing.T) {
	...
	invalidGenesisHashExtra := newIntroductionMessageExtra(pubkey, "amolecoin:0.26.0", params.VerifyTxn{
		BurnFactor:          4,
	...
	tt := []struct {
		...
		},
		{
			...
			intro: &IntroductionMessage{
				...
				ListenPort:      9982,
				ProtocolVersion: 1,
				Extra: newIntroductionMessageExtra(pubkey, "amolecoin:0.26.0", params.VerifyTxn{
					BurnFactor:          4,
					MaxTransactionSize:  32768,
					MaxDropletPrecision: 3,
				}, genesisHash),
		...
		},
		{
			...
			intro: &IntroductionMessage{
				...
				ListenPort:      9982,
				ProtocolVersion: 1,
				Extra: append(newIntroductionMessageExtra(pubkey, "amolecoin:0.26.0", params.VerifyTxn{
					BurnFactor:          4,
					MaxTransactionSize:  32768,
					MaxDropletPrecision: 3,
		...
		},
		{
			...
			intro: &IntroductionMessage{
				...
				ListenPort:      9982,
				ProtocolVersion: 1,
				Extra: newIntroductionMessageExtra(pubkey2, "amolecoin:0.26.0", params.VerifyTxn{
					BurnFactor:          4,
					MaxTransactionSize:  32768,
					MaxDropletPrecision: 3,
				}, genesisHash),
		...
		},
		{
			...
			intro: &IntroductionMessage{
				...
				ListenPort:      9982,
				ProtocolVersion: 1,
				Extra:           append(append(pubkey[:], []byte{5, 0, 0, 0, 32, 32, 32, 32, 1}...), encoder.SerializeString("amolecoin:0241")...),
			},
		},
		{
			...
			intro: &IntroductionMessage{
				...
				ListenPort:      9982,
				ProtocolVersion: 1,
				Extra:           append(append(pubkey[:], []byte{1, 0, 0, 0, 32, 32, 32, 32, 1}...), encoder.SerializeString("amolecoin:0.24.1")...),
			},
		},
		{
			...
			intro: &IntroductionMessage{
				...
				ListenPort:      9982,
				ProtocolVersion: 1,
				Extra:           append(append(pubkey[:], []byte{2, 0, 0, 0, 1, 0, 0, 0, 1}...), encoder.SerializeString("amolecoin:0.24.1")...),
			},
		},
		{
			...
			intro: &IntroductionMessage{
				...
				ListenPort:      9982,
				ProtocolVersion: 1,
				Extra:           append(append(pubkey[:], []byte{2, 0, 0, 0, 32, 32, 32, 32, 8}...), encoder.SerializeString("amolecoin:0.24.1")...),
			},
		},
		{
			name: "Disconnect self connection",
			addr: "12.12.12.12:9982",
			mockValue: daemonMockValue{
				mirror:           10000,
		...
		},
		{
			...
			intro: &IntroductionMessage{
				...
				ProtocolVersion: 1,
				ListenPort:      9982,
				Extra: newIntroductionMessageExtra(pubkey, "amolecoin:0.24.1(foo)", params.VerifyTxn{
					BurnFactor:          4,
					MaxTransactionSize:  32768,
					MaxDropletPrecision: 3,
				}, genesisHash),
		...
		},
		{
			...
			intro: &IntroductionMessage{
				...
				ProtocolVersion: 1,
				ListenPort:      9982,
				Extra: newIntroductionMessageExtra(pubkey, "amolecoin:0.26.0(foo)", params.VerifyTxn{
					BurnFactor:          4,
					MaxTransactionSize:  32768,
					MaxDropletPrecision: 3,
				}, genesisHash),
	...
	cases := []struct {
		...
		},
		{
			...
			msg: &IntroductionMessage{
				...
				ListenPort:      8888,
				ProtocolVersion: 12341234,
				Extra: newIntroductionMessageExtra(introPubKey, "amolecoin:0.26.0(foo)", params.VerifyTxn{
					BurnFactor:          2,
					MaxTransactionSize:  32768,
					MaxDropletPrecision: 3,
				}, introGenesisHash),
