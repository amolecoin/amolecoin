...
func testAmoleencoderTransaction(t *testing.T, obj *coin.Transaction) {
...
func TestAmoleencoderTransaction(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderTransaction(t, tc.obj)
		})
	}
}
...
func testAmoleencoderTransactionDecodeErrors(t *testing.T, k int, tag string, obj *coin.Transaction) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderTransactionDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderTransactionDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderTransactionDecodeErrors(t, i, "full", fullObj)
	}
}
