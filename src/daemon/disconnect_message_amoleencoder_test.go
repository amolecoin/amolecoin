...
func testAmoleencoderDisconnectMessage(t *testing.T, obj *DisconnectMessage) {
...
func TestAmoleencoderDisconnectMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderDisconnectMessage(t, tc.obj)
		})
	}
}
...
func testAmoleencoderDisconnectMessageDecodeErrors(t *testing.T, k int, tag string, obj *DisconnectMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderDisconnectMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderDisconnectMessageDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderDisconnectMessageDecodeErrors(t, i, "full", fullObj)
	}
}
