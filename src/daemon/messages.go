...
import (
	...
	"github.com/amolecoin/amolecoin/src/util/iputil"
...
//go:generate amoleencoder -unexported -struct IntroductionMessage
//go:generate amoleencoder -unexported -struct GivePeersMessage
//go:generate amoleencoder -unexported -struct GetBlocksMessage
//go:generate amoleencoder -unexported -struct GiveBlocksMessage
//go:generate amoleencoder -unexported -struct AnnounceBlocksMessage
//go:generate amoleencoder -unexported -struct GetTxnsMessage
//go:generate amoleencoder -unexported -struct GiveTxnsMessage
//go:generate amoleencoder -unexported -struct AnnounceTxnsMessage
//go:generate amoleencoder -unexported -struct DisconnectMessage
//go:generate amoleencoder -unexported -struct IPAddr
//go:generate amoleencoder -unexported -output-path . -package daemon -struct SignedBlock github.com/amolecoin/amolecoin/src/coin
//go:generate amoleencoder -unexported -output-path . -package daemon -struct Transaction github.com/amolecoin/amolecoin/src/coin
