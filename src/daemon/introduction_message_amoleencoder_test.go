...
func testAmoleencoderIntroductionMessage(t *testing.T, obj *IntroductionMessage) {
...
func TestAmoleencoderIntroductionMessage(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderIntroductionMessage(t, tc.obj)
		})
	}
}
...
func testAmoleencoderIntroductionMessageDecodeErrors(t *testing.T, k int, tag string, obj *IntroductionMessage) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderIntroductionMessageDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderIntroductionMessageDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderIntroductionMessageDecodeErrors(t, i, "full", fullObj)
	}
}
