...
func testAmoleencoderUxOut(t *testing.T, obj *coin.UxOut) {
...
func TestAmoleencoderUxOut(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderUxOut(t, tc.obj)
		})
	}
}
...
func testAmoleencoderUxOutDecodeErrors(t *testing.T, k int, tag string, obj *coin.UxOut) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderUxOutDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderUxOutDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderUxOutDecodeErrors(t, i, "full", fullObj)
	}
}
