...
func testAmoleencoderHashPairsWrapper(t *testing.T, obj *hashPairsWrapper) {
...
func TestAmoleencoderHashPairsWrapper(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderHashPairsWrapper(t, tc.obj)
		})
	}
}
...
func testAmoleencoderHashPairsWrapperDecodeErrors(t *testing.T, k int, tag string, obj *hashPairsWrapper) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderHashPairsWrapperDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderHashPairsWrapperDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderHashPairsWrapperDecodeErrors(t, i, "full", fullObj)
	}
}
