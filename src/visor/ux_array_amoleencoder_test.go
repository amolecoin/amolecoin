...
func testAmoleencoderUxArray(t *testing.T, obj *UxArray) {
...
func TestAmoleencoderUxArray(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderUxArray(t, tc.obj)
		})
	}
}
...
func testAmoleencoderUxArrayDecodeErrors(t *testing.T, k int, tag string, obj *UxArray) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderUxArrayDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderUxArrayDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderUxArrayDecodeErrors(t, i, "full", fullObj)
	}
}
