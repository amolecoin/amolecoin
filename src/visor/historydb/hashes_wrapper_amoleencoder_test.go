...
func testAmoleencoderHashesWrapper(t *testing.T, obj *hashesWrapper) {
...
func TestAmoleencoderHashesWrapper(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderHashesWrapper(t, tc.obj)
		})
	}
}
...
func testAmoleencoderHashesWrapperDecodeErrors(t *testing.T, k int, tag string, obj *hashesWrapper) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderHashesWrapperDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderHashesWrapperDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderHashesWrapperDecodeErrors(t, i, "full", fullObj)
	}
}
