...
func testAmoleencoderUnconfirmedTransaction(t *testing.T, obj *UnconfirmedTransaction) {
...
func TestAmoleencoderUnconfirmedTransaction(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderUnconfirmedTransaction(t, tc.obj)
		})
	}
}
...
func testAmoleencoderUnconfirmedTransactionDecodeErrors(t *testing.T, k int, tag string, obj *UnconfirmedTransaction) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderUnconfirmedTransactionDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderUnconfirmedTransactionDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderUnconfirmedTransactionDecodeErrors(t, i, "full", fullObj)
	}
}
