...
A droplet is the smallest possible coin amount in Amolecoin, equal to 1/1000000 of a whole amolecoin.
*/
package droplet
...
import (
	...
	logging "github.com/amolecoin/amolecoin/src/util/logging"
)
...
// FromString converts a amolecoin balance string with decimal places to uint64 droplets.
...
func FromString(b string) (uint64, error) {
	...
	// Amolecoins have a maximum of 6 decimal places
...
// ToString converts droplets to a amolecoin balance fixed-point decimal string.
