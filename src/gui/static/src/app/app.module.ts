...
import { SendAmolecoinComponent } from './components/pages/send-amolecoin/send-amolecoin.component';
...
import { SendVerifyComponent } from './components/pages/send-amolecoin/send-preview/send-preview.component';
import { TransactionInfoComponent } from './components/pages/send-amolecoin/send-preview/transaction-info/transaction-info.component';
import { SendCoinsFormComponent } from './components/pages/send-amolecoin/send-coins-form/send-coins-form.component';
...
import { ChangeNoteComponent } from './components/pages/send-amolecoin/send-preview/transaction-info/change-note/change-note.component';
...
import { FormSourceSelectionComponent } from './components/pages/send-amolecoin/form-parts/form-source-selection/form-source-selection.component';
import { FormDestinationComponent } from './components/pages/send-amolecoin/form-parts/form-destination/form-destination.component';
import { CopyRawTxComponent } from './components/pages/send-amolecoin/offline-dialogs/implementations/copy-raw-tx.component';
import { SignRawTxComponent } from './components/pages/send-amolecoin/offline-dialogs/implementations/sign-raw-tx.component';
import { BroadcastRawTxComponent } from './components/pages/send-amolecoin/offline-dialogs/implementations/broadcast-raw-tx.component';
import { OfflineDialogsBaseComponent } from './components/pages/send-amolecoin/offline-dialogs/offline-dialogs-base.component';
...
const ROUTES = [
  ...
  {
    path: 'send',
    component: SendAmolecoinComponent,
    canActivate: [WizardGuardService],
  },
  {
    path: 'transactions',
