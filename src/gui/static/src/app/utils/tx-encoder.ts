...
export class TxEncoder {
  /**
   * Creates an encoded transaction using the Amolecoin format. Check the encoded Amolecoin
   ...
   * @param transactionType Number identifying the type of the transaction, as per the Amolecoin
   * transaction format.
   */
