 ...
 */
@Component({
  selector: 'app-send-amolecoin',
  templateUrl: './send-amolecoin.component.html',
  styleUrls: ['./send-amolecoin.component.scss'],
})
export class SendAmolecoinComponent implements OnDestroy {
