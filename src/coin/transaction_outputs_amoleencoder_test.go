...
func testAmoleencoderTransactionOutputs(t *testing.T, obj *transactionOutputs) {
...
func TestAmoleencoderTransactionOutputs(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderTransactionOutputs(t, tc.obj)
		})
	}
}
...
func testAmoleencoderTransactionOutputsDecodeErrors(t *testing.T, k int, tag string, obj *transactionOutputs) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderTransactionOutputsDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderTransactionOutputsDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderTransactionOutputsDecodeErrors(t, i, "full", fullObj)
	}
}
