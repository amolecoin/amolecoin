...
func testAmoleencoderTransactionInputs(t *testing.T, obj *transactionInputs) {
...
func TestAmoleencoderTransactionInputs(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testAmoleencoderTransactionInputs(t, tc.obj)
		})
	}
}
...
func testAmoleencoderTransactionInputsDecodeErrors(t *testing.T, k int, tag string, obj *transactionInputs) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestAmoleencoderTransactionInputsDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testAmoleencoderTransactionInputsDecodeErrors(t, i, "empty", emptyObj)
		testAmoleencoderTransactionInputsDecodeErrors(t, i, "full", fullObj)
	}
}
