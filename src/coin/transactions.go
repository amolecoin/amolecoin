...
//go:generate amoleencoder -struct Transaction -unexported
//go:generate amoleencoder -struct transactionInputs
//go:generate amoleencoder -struct transactionOutputs
