...
import (
	...
	"github.com/amolecoin/amolecoin/src/api"
	...
	"github.com/amolecoin/amolecoin/src/coin"
	"github.com/amolecoin/amolecoin/src/readable"
	"github.com/amolecoin/amolecoin/src/testutil"
	"github.com/amolecoin/amolecoin/src/util/droplet"
	wh "github.com/amolecoin/amolecoin/src/util/http"
	"github.com/amolecoin/amolecoin/src/wallet"
)

const (
	binaryName = "amolecoin-cli.test"
...
var (
	...
	stripCoverageReport = regexp.MustCompile(`PASS\ncoverage: [\d\.]+% of statements in github.com/amolecoin/amolecoin/\.\.\.\n$`)
)
...
func execCommandCombinedOutput(args ...string) ([]byte, error) {
	...
	// PASS
	// coverage: 8.1% of statements in github.com/amolecoin/amolecoin/...
...
func TestMain(m *testing.M) {
	...
	// args := []string{"build", "-o", binaryPath, "../../../cmd/amolecoin-cli/amolecoin-cli.go"}
	// Compile the binary with test flags enabled to get a coverage report from the binary
	args := []string{"test", "-c", "-tags", "testrunmain", "-o", binaryPath, "-coverpkg=github.com/amolecoin/amolecoin/...", "../../../cmd/amolecoin-cli/"}
...
func mode(t *testing.T) string {
	mode := os.Getenv("AMOLECOIN_INTEGRATION_TEST_MODE")
	switch mode {
	case "":
		mode = testModeStable
...
func enabled() bool {
	return os.Getenv("AMOLECOIN_INTEGRATION_TESTS") == "1"
}
...
func TestVerifyAddress(t *testing.T) {
	...
	tt := []struct {
		...
		{
			"valid amolecoin address",
			"2Kg3eRXUhY6hrDZvNGB99DKahtrPDQ1W9vN",
			nil,
			"",
		},
		{
			"invalid amolecoin address",
...
func TestDecodeRawTransaction(t *testing.T) {
	...
	tt := []struct {
		...
		{
			name:       "success",
			rawTx:      "",
...
func TestEncodeJSONTransaction(t *testing.T) {
	...
	tt := []struct {
		...
		},
		{
			...
			rawTx: "",
	...
	tt := []struct {
	...
	}{
		{
			...
			check: func(t *testing.T, v []byte) {
				...
				// Confirms the wallet type is amolecoin
				require.Equal(t, wallet.CoinTypeAmolecoin, wallet.CoinType(w.Meta["coin"]))
...
func TestStableShowConfig(t *testing.T) {
	...
	require.True(t, strings.HasSuffix(ret.DataDir, ".amolecoin"))

	ret.DataDir = "IGNORED/.amolecoin"
...
func TestLiveSend(t *testing.T) {
	...
	tt := []struct {
		...
		},
		{
			...
			errMsg:   []byte("See 'amolecoin-cli send --help'\nError: Transaction has zero coinhour fee"),
			checkTxn: func(t *testing.T, txid string) {},
		},
	}
...
func TestVersion(t *testing.T) {
	...
	var ver = struct {
		Amolecoin string `json:"amolecoin"`
		Cli     string `json:"cli"`
		RPC     string `json:"rpc"`
...
func TestStableWalletCreate(t *testing.T) {
	...
	defaultFilename := "amolecoin-cli-integration-test.wlt"
