...
func addressGenCmd() *cobra.Command {
	addressGenCmd := &cobra.Command{
		Short: "Generate amolecoin or bitcoin addresses",
		Use:   "addressGen",
	...
	addressGenCmd.Flags().StringP("coin", "c", "amolecoin", "Coin type. Must be amolecoin or bitcoin. If bitcoin, secret keys are in Wallet Import Format instead of hex.")
