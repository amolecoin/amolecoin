...
import (
	...
	secp256k1 "github.com/amolecoin/amolecoin/src/cipher/secp256k1-go"
...
func walletCreateCmd() *cobra.Command {
	...
	walletCreateCmd.Flags().Uint32P("bip44-coin", "", uint32(bip44.CoinTypeAmolecoin), "BIP44 coin type")
	walletCreateCmd.Flags().StringP("coin", "c", string(wallet.CoinTypeAmolecoin), "Wallet address coin type (options: amolecoin, bitcoin)")
