...
const (
	blockchainPubkey = "02f37a1c7ebb2716404c1973cd5b3132a313e77b848fa25628bf1520d05365c5dc"
)
...
func checkDBCmd() *cobra.Command {
	return &cobra.Command{
		...
		Use:   "checkdb [db path]",
		Long: `Checks if the given database file contains valid amolecoin blockchain data.
...
func checkDBDecoding(_ *cobra.Command, args []string) error {
	...
	if err := visor.VerifyDBAmoleencoderSafe(wrapDB(db), quitChan); err != nil {
		if err == visor.ErrVerifyStopped {
			return nil
		}
