...
REST API to query a amolecoin node's status.
*/
package cli
...
const (
	...
	defaultCoin       = "amolecoin"
	defaultRPCAddress = "http://127.0.0.1:9981"
...
func NewCLI(cfg Config) (*cobra.Command, error) {
	...
	amoleCLI.Version = Version
	amoleCLI.SuggestionsMinimumDistance = 1
	amoleCLI.AddCommand(commands...)

	amoleCLI.SetHelpTemplate(helpTemplate)
	amoleCLI.SetUsageTemplate(helpTemplate)
