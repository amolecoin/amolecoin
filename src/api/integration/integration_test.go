...
import (
	...
	"github.com/amolecoin/amolecoin/src/daemon"
	"github.com/amolecoin/amolecoin/src/readable"
	"github.com/amolecoin/amolecoin/src/testutil"
	"github.com/amolecoin/amolecoin/src/transaction"
	"github.com/amolecoin/amolecoin/src/util/droplet"
	"github.com/amolecoin/amolecoin/src/util/mathutil"
	"github.com/amolecoin/amolecoin/src/util/useragent"
	"github.com/amolecoin/amolecoin/src/visor"
)

/* Runs HTTP API tests against a running amolecoin node

Set envvar AMOLECOIN_INTEGRATION_TESTS=1 to enable them
Set AMOLECOIN_NODE_HOST to the node's address (defaults to http://127.0.0.1:9981)
Set AMOLECOIN_INTEGRATION_TEST_MODE to either "stable" or "live" (defaults to "stable")
...
Make sure the amolecoin node is running against the pinned blockchain data provided in this package's folder.
...
func nodeAddress() string {
	addr := os.Getenv("AMOLECOIN_NODE_HOST")
	if addr == "" {
...
func nodeUsername() string {
	return os.Getenv("AMOLECOIN_NODE_USERNAME")
}

func nodePassword() string {
	return os.Getenv("AMOLECOIN_NODE_PASSWORD")
}
...
func TestLiveBalance(t *testing.T) {
	...
	b, err := c.Balance([]string{"vczdwAwVsyVoGyZCFBoRPyWU3Qq35Ln1XB"})
	require.NoError(t, err)
	require.Equal(t, api.BalanceResponse{
		Addresses: readable.AddressBalances{
			"vczdwAwVsyVoGyZCFBoRPyWU3Qq35Ln1XB": readable.BalancePair{},
		},
	}, *b)
...
func TestStableTransactions(t *testing.T) {
	...
	cases := []transactionsTestCase{
		...
		{
			name:       "genesis",
			addrs:      []string{"vczdwAwVsyVoGyZCFBoRPyWU3Qq35Ln1XB"},
...
func TestLiveRawTransaction(t *testing.T) {
	...
	cases := []rawTransactionTestCase{
		...
		},
		{
			name:   "OK",
			txID:   "540582ee4128b733f810f149e908d984a5f403ad2865108e6c1c5423aeefc759",
			rawTxn: "",
		},
	}
	...
	cases := []addressTransactionsTestCase{
		{
			...
			address: "vczdwAwVsyVoGyZCFBoRPyWU3Qq35Ln1XB",
			golden:  "address-transactions-vczdwAwVsyVoGyZCFBoRPyWU3Qq35Ln1XB.golden",
		},
		{
