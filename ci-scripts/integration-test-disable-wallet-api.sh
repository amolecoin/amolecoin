#!/bin/bash
# Runs "disable-wallet-api"-mode tests against a amolecoin node configured with the wallet API disabled.
...
AMOLECOIN_INTEGRATION_TESTS=1 AMOLECOIN_INTEGRATION_TEST_MODE=$MODE AMOLECOIN_NODE_HOST=$HOST API_WALLET_DIR=$WALLET_DIR \
