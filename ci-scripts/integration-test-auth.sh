...
AMOLECOIN_INTEGRATION_TESTS=1 AMOLECOIN_INTEGRATION_TEST_MODE=$MODE \
AMOLECOIN_NODE_HOST=$HOST AMOLECOIN_NODE_USERNAME=$WEB_USERNAME AMOLECOIN_NODE_PASSWORD=$WEB_PASSWORD \
